...
angular.module('openWeatherApp.services', ['ngResource'])
  ...
  //
  .value('exampleLocations',['Rosario','San Francisco','Berlin','Athens','Tokyo','New York','Moscow','Clonakilty'])
  //
  // Storm "Xaver" special locations
  //
  .value('stormLocations',['Sylt','St. Peter-Ording','Husum','Bremerhaven','Rosario','Kiel','Lübeck'])
